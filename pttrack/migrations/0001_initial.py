    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinic_type', models.CharField(default=b'SATUR', max_length=5, choices=[(b'SATUR', b'Saturday Basic'), (b'PSYCH', b'Depression & Anxiety Specialty'), (b'ORTHO', b'Muscle and Joint Pain Specialty'), (b'DERMA', b'Dermatology Specialty')])),
