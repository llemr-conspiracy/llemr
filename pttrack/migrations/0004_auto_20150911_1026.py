    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcp_preferred_zip', models.CharField(blank=True, max_length=5, null=True, validators=[pttrack.models.validate_zip])),
                ('date_of_birth', models.DateField(validators=[pttrack.models.validate_birth_date])),
        ...
        migrations.AlterField(
            model_name='patient',
            name='date_of_birth',
            field=models.DateField(validators=[pttrack.models.validate_birth_date]),
        ),
        migrations.AddField(
