...
unwrapped_urlpatterns = [  # pylint: disable=invalid-name
    ...
    #     views.PtListLatest.as_view(),
    #     name='pt_list_latest_api'),
    # url(r'^pt_list_active/$',
    #     views.PtListActive.as_view(),
    #     name='pt_list_active_api'),
    # url(r'^pt_list_ai_active/$',
    #     views.PtListActionItemListActive.as_view(),
    #     name='pt_list_ai_active_api'),
    # url(r'^pt_list_ai_inactive/$',
    #     views.PtListActionItemListInactive.as_view(),
    #     name='pt_list_ai_inactive_api'),
    # url(r'^pt_list_unsigned/$',
    #     views.PtListWorkupUnsigned.as_view(),
    #     name='pt_list_unsigned_api'),
