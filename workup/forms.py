            ...
            TabHolder(
                ...
                Tab('Physical Exam',
                    Div(
                        ...
                        #    css_class='col-lg-1'),
                        Div(AppendedText('hr', 'bpm'), css_class='col-lg-2'),
                        Div(AppendedText('bp', 'mmHg'), css_class='col-lg-2'),
                        Div(AppendedText('rr', '/min'), css_class='col-lg-2'),
                        Div(AppendedText('t', 'C'), css_class='col-lg-2'),
                        Div(AppendedText('height', 'in'), css_class='col-lg-2'),
                        Div(AppendedText('weight', 'kg'), css_class='col-lg-2'),
                        title="Vital Signs",
                        css_class="col-lg-12"),
                    'pe'),
                Tab('Assessment & Plan',
