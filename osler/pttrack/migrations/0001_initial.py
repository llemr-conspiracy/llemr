    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(help_text='Please deidentify all file names before upload! Delete all files after upload!', upload_to=osler.pttrack.models.make_filepath, verbose_name='PDF File or Image Upload')),
                ('comments', models.TextField()),
            ],
            options={
                'ordering': ['-written_datetime', '-last_modified'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('first_name', models.CharField(max_length=100, validators=[osler.pttrack.validators.validate_name])),
                ('last_name', models.CharField(max_length=100, validators=[osler.pttrack.validators.validate_name])),
                ('middle_name', models.CharField(blank=True, max_length=100, validators=[osler.pttrack.validators.validate_name])),
                ...
                ('zip_code', models.CharField(max_length=5, validators=[osler.pttrack.validators.validate_zip])),
                ('country', models.CharField(default='USA', max_length=100)),
                ('pcp_preferred_zip', models.CharField(blank=True, max_length=5, null=True, validators=[osler.pttrack.validators.validate_zip])),
                ('date_of_birth', models.DateField(help_text='MM/DD/YYYY', validators=[osler.pttrack.validators.validate_birth_date])),
