    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bp_sys', models.PositiveSmallIntegerField(blank=True, null=True, validators=[osler.workup.validators.validate_bp_systolic], verbose_name='Systolic')),
                ('bp_dia', models.PositiveSmallIntegerField(blank=True, null=True, validators=[osler.workup.validators.validate_bp_diastolic], verbose_name='Diastolic')),
                ...
                ('attending', models.ForeignKey(blank=True, help_text='Which attending saw the patient?', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='attending_physician', to=settings.AUTH_USER_MODEL, validators=[osler.core.validators.validate_attending])),
                ...
                ('other_volunteer', models.ManyToManyField(blank=True, help_text='Which other volunteer(s) did you work with (if any)?', related_name='other_volunteer', to=settings.AUTH_USER_MODEL)),
                ...
                ('signer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='signed_workup_workup', to=settings.AUTH_USER_MODEL, validators=[osler.core.validators.validate_attending])),
            ],
            options={
                'permissions': [('can_sign', 'Can sign note'), ('can_export_pdf', 'Can export note PDF')],
                'abstract': False,
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='auth.Group')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Patient')),
                ('signer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='signed_workup_progressnote', to=settings.AUTH_USER_MODEL, validators=[osler.core.validators.validate_attending])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attending', models.ForeignKey(blank=True, db_constraint=False, help_text='Which attending saw the patient?', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, validators=[osler.core.validators.validate_attending])),
                ...
                ('signer', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, validators=[osler.core.validators.validate_attending])),
            ],
            options={
