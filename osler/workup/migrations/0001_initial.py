# Generated by Django 3.0.5 on 2020-08-10 23:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labs_ordered_quest', models.TextField(blank=True, null=True, verbose_name='Labs Ordered Externally')),
                ...
                ('attending', models.ForeignKey(blank=True, help_text='Which attending saw the patient?', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='attending_physician', to=settings.AUTH_USER_MODEL)),
                ...
                ('signer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='signed_workup_workup', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': [('can_export_pdf_Workup', 'Can export note PDF'), ('can_sign_Workup', 'Can sign note')],
            },
        ),
        migrations.CreateModel(
            name='ProgressNote',
            fields=[
                ...
                ('author_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='auth.Group')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Patient')),
                ('signer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='signed_workup_progressnote', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': [('can_sign_ProgressNote', 'Can sign note')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attending', models.ForeignKey(blank=True, db_constraint=False, help_text='Which attending saw the patient?', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
