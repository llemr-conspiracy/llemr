...
#thinking it would be best to test just the views that send out json by filling up the json with fake data and asserting similarity
...
#   def test_list_clinic_dates_view(self):
#       response = self.client.get(reverse('datadashboard:context-json-datadashboard'))
#       test_encounters = core_factories.EncounterFactory.create_batch(5)
