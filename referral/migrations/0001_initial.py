# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2018-10-18 17:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('written_datetime', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('has_appointment', models.CharField(blank=True, choices=[(b'Y', b'Yes'), (b'N', b'No'), (b'?', b'Not yet')], help_text=b'Did the patient make an appointment?', max_length=1, verbose_name=b'Appointment scheduled?')),
                ('pt_showed', models.CharField(blank=True, choices=[(b'Y', b'Yes'), (b'N', b'No'), (b'?', b'Not yet')], help_text=b'Did the patient show up to the appointment?', max_length=1, null=True, verbose_name=b'Appointment attended?')),
