...
class Migration(migrations.Migration):
    ...
    state_operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attempt_again', models.BooleanField(
                    default=False,
                    help_text=b'True if outcome means the pt should be contacted again.')),
                ('patient_reached', models.BooleanField(
                    default=True,
                    help_text=b'True if the outcome means they did not reach the patient')),
            ],
            options={
                'db_table': 'followup_contactresult',
            }
        ),
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'db_table': 'followup_generalfollowup'
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'followup_historicalgeneralfollowup'
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'followup_historicallabfollowup'
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_resolution', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='followup.ContactResult', null=True)),
                ('history_user', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, null=True)),
                ('noapt_reason', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='followup.NoAptReason', null=True)),
                ('noshow_reason', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='followup.NoShowReason', null=True)),
                ('patient', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='pttrack.Patient', null=True)),
                ('referral_type', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='pttrack.ReferralType', null=True))
            ],
            options={
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
                'verbose_name': 'historical referral followup',
                'db_table': 'followup_historicalreferralfollowup'
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'followup_historicalvaccinefollowup'
            },
        ),
        migrations.CreateModel(
            name='LabFollowup',
        ...
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'db_table': 'followup_referralfollowup'
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('comments', models.TextField(null=True, blank=True)),
                ('subsq_dose', models.BooleanField(
                    verbose_name=b'Has the patient committed to coming back for another dose?')),
                ('dose_date', models.DateField(
                    help_text=b'When does the patient want to get their next dose (if applicable)?',
            ...
            options={
                'abstract': False,
                'db_table': 'followup_vaccinefollowup'
            },
        ),
    ]
